...
interface ConfigureAzureDevOpsModalProps {
  ...
  existingConfig?: AzureDevOpsIntegration;
  onSuccess: () => void;
}

export const ConfigureAzureDevOpsModal = ({
  isOpen,
  onClose,
  organizationId,
  existingConfig,
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
        <div className="border-b dark:border-gray-700 px-6 py-4 flex justify-between items-center">
          <h2 className="text-xl font-semibold dark:text-white">
            {existingConfig ? t("integrations.editAzureDevOps") : t("integrations.configureAzureDevOps")}
          </h2>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSave} className="p-6 space-y-4">
          <div>
            <label htmlFor="organization" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
              {t("integrations.azureDevops.organization")} *
            </label>
            <input
              id="organization"
              type="text"
            ...
            <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
              Example: your-organization (from dev.azure.com/your-organization)
            </p>
          </div>

          <div>
            <label htmlFor="pat" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
              {t("integrations.azureDevops.pat")} *
            </label>
            <input
              id="pat"
              type="password"
          ...
          <div className="flex justify-end gap-2 pt-4">
            ...
            <Button
              ...
              variant="secondary"
              disabled={isTesting || isSubmitting || !formData.organization || !formData.pat}
            >
